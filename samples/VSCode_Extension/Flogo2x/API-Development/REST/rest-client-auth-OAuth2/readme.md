...
![Copy App](/samples/VSCode_Extension/Flogo2x/images/REST/OAuth2_GoogleTask_Sample/CopyApp.png)
...
![The connection1](/samples/VSCode_Extension/Flogo2x/images/REST/OAuth2_GoogleTask_Sample/Connection1.png)

![The connection2](/samples/VSCode_Extension/Flogo2x/images/REST/OAuth2_GoogleTask_Sample/Connection2.png)
...
![Sample Flow](/samples/VSCode_Extension/Flogo2x/images/REST/OAuth2_GoogleTask_Sample/Flow.png)

![Sample Activity](/samples/VSCode_Extension/Flogo2x/images/REST/OAuth2_GoogleTask_Sample/Activity.png)
...
![Run Application](/samples/VSCode_Extension/Flogo2x/images/REST/OAuth2_GoogleTask_Sample/RunApplication.png)

![Sample Configuration](/samples/VSCode_Extension/Flogo2x/images/REST/OAuth2_GoogleTask_Sample/Sample%20Configuration.png)

![Sample Response](/samples/VSCode_Extension/Flogo2x/images/REST/OAuth2_GoogleTask_Sample/SampleResponse1.png)
...
1. Sample Response
![Sample Response](/samples/VSCode_Extension/Flogo2x/images/REST/OAuth2_GoogleTask_Sample/SampleResponse2.png)

2. Sample Logs
![Sample Logs](/samples/VSCode_Extension/Flogo2x/images/REST/OAuth2_GoogleTask_Sample/SampleLogs.png)
