...
![Copy App](/samples/VSCode_Extension/Flogo2x/images/Redis/CopyApp.png)

## Understanding the configuration

### The Connection

![The connection 1](/samples/VSCode_Extension/Flogo2x/images/Redis/Connection1.png)

![The connection 2](/samples/VSCode_Extension/Flogo2x/images/Redis/Connection2.png)
...
![Sample Response 1](/samples/VSCode_Extension/Flogo2x/images/Redis/SampleResponse1.png)

![Sample Response 2](/samples/VSCode_Extension/Flogo2x/images/Redis/SampleResponse2.png)
...
![Sample Response 3](/samples/VSCode_Extension/Flogo2x/images/Redis/SampleResponse3.png)

![Sample Response 4](/samples/VSCode_Extension/Flogo2x/images/Redis/SampleResponse4.png)

### Run the application

Once you are ready to run the application, use the Run option to start the app.

![Sample Response 5](/samples/VSCode_Extension/Flogo2x/images/Redis/SampleResponse5.png)
...
![Sample Response 6](/samples/VSCode_Extension/Flogo2x/images/Redis/SampleResponse6.png)

## Outputs

1. Output of Redis-Sets-App.flogo app:

![Output 1](/samples/VSCode_Extension/Flogo2x/images/Redis/Output1.png)

2. Logs of Redis-Sets-App.flogo app:

![Output 2](/samples/VSCode_Extension/Flogo2x/images/Redis/Output2.png)
