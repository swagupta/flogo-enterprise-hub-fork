...
![Copy App](/samples/VSCode_Extension/Flogo2x/images/CRM/Salesforce/Salesforce_BulkAPISample/CopyApp.png)
...
![The connection](/samples/VSCode_Extension/Flogo2x/images/CRM/Salesforce/Salesforce_BulkAPISample/Connection1.png)
...
![The connection](/samples/VSCode_Extension/Flogo2x/images/CRM/Salesforce/Salesforce_BulkAPISample/Connection2.png)
...
![The Flows](/samples/VSCode_Extension/Flogo2x/images/CRM/Salesforce/Salesforce_BulkAPISample/Flow.png)
...
![The Main Flow](/samples/VSCode_Extension/Flogo2x/images/CRM/Salesforce/Salesforce_BulkAPISample/MainFlow.png)
...
![The Sub Flow](/samples/VSCode_Extension/Flogo2x/images/CRM/Salesforce/Salesforce_BulkAPISample/SubFlow.png)

### Run the application
Once you are ready to run the application, use the Run option to start the app.

![Run App 1](/samples/VSCode_Extension/Flogo2x/images/CRM/Salesforce/Salesforce_BulkAPISample/Run1.png)
...
![Run App 2](/samples/VSCode_Extension/Flogo2x/images/CRM/Salesforce/Salesforce_BulkAPISample/Run2.png)

## Outputs

1. Sample Response when hit the endpoints
![Sample Response](/samples/VSCode_Extension/Flogo2x/images/CRM/Salesforce/Salesforce_BulkAPISample/Response.png)

2. Sample Logs
![Sample Log 1](/samples/VSCode_Extension/Flogo2x/images/CRM/Salesforce/Salesforce_BulkAPISample/Log1.png)

![Sample Log 2](/samples/VSCode_Extension/Flogo2x/images/CRM/Salesforce/Salesforce_BulkAPISample/Log2.png)
